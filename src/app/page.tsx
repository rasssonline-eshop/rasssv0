  ...
  return (
    <main className="bg-gray-50 min-h-screen">
      ...
      <section className="my-8">
        <div className="relative w-full max-w-[3200px] mx-auto overflow-hidden aspect-[16/9] md:aspect-[21/9] md:rounded-xl md:shadow-lg">
          <Image
            src={banner2Src}
            alt="Skin Care Deals"
            fill
          ...
          <div className="absolute inset-0 flex flex-col items-center justify-center text-center text-white px-6 gap-3">
            ...
            <p className="text-base md:text-xl max-w-2xl">{t("home.findFast")}</p>
            <div className="flex gap-3">
              <a href="#categories" className="inline-flex">
                <button className="bg-white text-gray-900 hover:bg-gray-100 px-6 py-3 rounded-full font-medium transition-all hover:scale-105 active:scale-95 shadow-md">
                  {t("home.viewCategories")}
                </button>
              </a>
              <a href="/flash-sales" className="inline-flex">
                <button className="bg-primary text-white hover:bg-primary/90 px-6 py-3 rounded-full font-medium transition-all hover:scale-105 active:scale-95 shadow-md">
                  {t("home.shopNow")}
                </button>
              </a>
            </div>
