    ...
    <div className="container mx-auto px-4 py-12 max-w-4xl">
      <div className="mb-8">
        ...
        <p className="text-gray-600">
          Add your payment details to receive payments from customers
        </p>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Choose one payment method to receive your payouts
            </CardDescription>
          </CardHeader>
          <CardContent>
        ...
        {paymentType === "jazzcash" && (
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Enter your JazzCash mobile wallet number
              </CardDescription>
            </CardHeader>
        ...
        {paymentType === "easypaisa" && (
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Enter your EasyPaisa mobile wallet number
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              <div className="space-y-2">
      ...
      <Card className="mt-6 bg-blue-50 border-blue-200">
        <CardContent className="pt-6">
          ...
          <ul className="text-sm text-blue-800 space-y-1">
            <li>• You can only select ONE payment method at a time</li>
            <li>• Your payment details are securely stored and encrypted</li>
            <li>• Admin will use this method to send your payouts</li>
            <li>• You can change your payment method anytime</li>
            <li>• Changing payment method will replace the previous one</li>
          </ul>
        </CardContent>
      </Card>
    </div>
