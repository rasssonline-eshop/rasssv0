...
const dict: Record<Lang, Record<string, string>> = {
  en: {
    ...
    "cat.makeup": "Makeup",
    "cat.babyCareDiapers": "Baby Care & Diapers",
    "cat.vitamins": "Vitamins",
    "cat.skinCare": "Skin Care",
    "cat.babyAccessories": "Baby Accessories",
  ...
  ur: {
    ...
    "cat.fragrances": "خوشبوئیں",
    "cat.makeup": "میک اپ",
    "cat.babyCareDiapers": "بچے کی دیکھ بھال اور ڈائپرز",
    "cat.vitamins": "وٹامنز",
    "cat.skinCare": "اسکن کیئر",
    "cat.babyAccessories": "بچے کے لوازمات",
    "cat.hairCare": "بالوں کی دیکھ بھال",
